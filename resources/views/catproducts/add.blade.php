            ...
            <div class="container col-md-8 col-md-offset-0">
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h2>Altas Categorias Productos</h2>
                    </div>
                        ...
                        <form class="form form-group" method="POST">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="cod_categoria" placeholder="codigo categoria" name="cod_categoria">
                                    </div>
                                </div>
                              <!---->
                                <!-- Descripcion -->
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="des_categoria" placeholder="descripción" name="des_categoria">
                                    </div>
                                </div>
